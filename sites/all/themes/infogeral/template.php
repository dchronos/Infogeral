 ...
 */
function infogeral_css_alter(&$css) {
 ...
 */
function infogeral_preprocess_html(&$variables) {
  // Add reset CSS
 ...
 */
function infogeral_process_html(&$variables) {
 ...
 */
function infogeral_preprocess_page(&$variables) {
 ...
 */
function infogeral_process_page(&$variables) {
}

/**
 * Implements template_preprocess_block().
 */
function infogeral_preprocess_block(&$variables) {
 ...
 */
function infogeral_more_link($variables) {
  // Append arrow
 ...
 */
function infogeral_messages($variables) {
 ...
 */
function infogeral_node_recent_block($variables) {
 ...
 */
function infogeral_node_recent_content($variables) {
  // Make output for "Recent content" block consistent with other blocks
  $node = $variables['node'];
 ...
 */
function infogeral_tablesort_indicator($variables) {
 ...
 */
function infogeral_pager($variables) {
