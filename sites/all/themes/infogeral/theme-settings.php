...
function infogeral_form_system_theme_settings_alter(&$form, $form_state) {
  ...
  $form['custom']['trim_pager'] = array(
    ...
    '#options' => infogeral_generate_array(4, 15, 1, ''),
  );
}

function infogeral_generate_array($min, $max, $increment, $postfix, $unlimited = NULL) {
  $array = array();
  if ($unlimited == 'first') {
